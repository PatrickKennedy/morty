/**
 * The underlying structure for the Morty plugin framework.
 * Plugin attempts to automate much of the boilerplate necessary on all
...
module.exports = class Plugin {
   ...
   * @param {Plugin} plugin - the instance of the plugin loaded
   */
  loaded(plugin) {}
